...
Timer::Timer(Alu &a) :
  Block(a),
  ckcon("CKCON", a, 0x8e, 0, {0x0}),
  th1("TH1", a, 0x8d, 0, {0x0}),
  th0("TH0", a, 0x8c, 0, {0x0}),
  tl1("TL1", a, 0x8b, 0, {0x0}),
  tl0("TL0", a, 0x8a, 0, {0x0}),
  tmod("TMOD", a, 0x89, 0, {0x0}),
  tcon("TCON", a, 0x88, 0, {0x0}),
  tmr2rll("TMR2RLL", a, 0xca, 0, {0x0}),
  tmr2rlh("TMR2RLH", a, 0xcb, 0, {0x0}),
  tmr2l("TMR2L", a, 0xcc, 0, {0x0}),
  tmr2h("TMR2H", a, 0xcd, 0, {0x0}),
  tmr2cn("TMR2CN", a, 0xc8, 0, {0x0})
{
}
